...
class Cutscene5Screen extends Screen
{
	public function new()
	{
		super();
		
		var cutscene5Data:BitmapData = Assets.getBitmapData( "img/Art#5.png");
		var cutscene5:Bitmap = new Bitmap( cutscene5Data );
		addChild(cutscene5);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Cutscene6 );
	}
