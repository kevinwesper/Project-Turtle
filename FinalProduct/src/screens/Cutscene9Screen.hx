...
class Cutscene9Screen extends Screen
{
	public function new()
	{
		super();
		
		var cutscene9Data:BitmapData = Assets.getBitmapData( "img/Art#9.png");
		var cutscene9:Bitmap = new Bitmap( cutscene9Data );
		addChild(cutscene9);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Cutscene10);
	}
