...
class Cutscene3Screen extends Screen
{
	public function new()
	{
		...
		var cutscene3Data:BitmapData = Assets.getBitmapData( "img/Art#3.png");
		var cutscene3:Bitmap = new Bitmap( cutscene3Data );
		addChild(cutscene3);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Cutscene4 );
	}
