...
class Battle5Screen extends Screen
{
	...
	{
		enemyData = Assets.getBitmapData( "img/Fuckinghenry.png");
	...
	{ 
		...
		for ( column in 0...5 )
		{
			...
			{
				Main.instance.loadScreen (ScreenTypes.Dead5);
			}
	...
	function enemyTurn()
	{
		...
		{
			enemyToPlayerDamage = Math.ceil( 15 + (10 * Math.random()) );
