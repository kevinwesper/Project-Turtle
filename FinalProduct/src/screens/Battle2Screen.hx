...
class Battle2Screen extends Screen
{
	...
	{
		enemyData = Assets.getBitmapData( "img/Woofballs.png");
	...
	{ 
		...
		for ( column in 0...5 )
		{
			...
			{
				Main.instance.loadScreen (ScreenTypes.Dead2);
			}
	...
	function enemyTurn()
	{
		...
		{
			enemyToPlayerDamage = Math.ceil( 10 + (10 * Math.random()) );
