...
class Cutscene6Screen extends Screen
{
	public function new()
	{
		super();
		
		var cutscene6Data:BitmapData = Assets.getBitmapData( "img/Art#6.png");
		var cutscene6:Bitmap = new Bitmap( cutscene6Data );
		addChild(cutscene6);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Battle2 );
	}
