...
class Cutscene8Screen extends Screen
{
	public function new()
	{
		...
		var cutscene8Data:BitmapData = Assets.getBitmapData( "img/Art#8.png");
		var cutscene8:Bitmap = new Bitmap( cutscene8Data );
		addChild(cutscene8);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Battle4 );
	}
