...
class Cutscene11Screen extends Screen
{
	public function new()
	{
		super();
		
		var cutscene11Data:BitmapData = Assets.getBitmapData( "img/Art#11.png");
		var cutscene11:Bitmap = new Bitmap( cutscene11Data );
		addChild(cutscene11);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Cutscene12 );
	}
