...
class Cutscene12Screen extends Screen
{
	public function new()
	{
		super();
		
		var cutscene12Data:BitmapData = Assets.getBitmapData( "img/Art#12.png");
		var cutscene12:Bitmap = new Bitmap( cutscene12Data );
		addChild(cutscene12);
	}
	...
	{
		Main.instance.loadScreen( ScreenTypes.Cutscene13 );
	}
